...
namespace HttpServer
{
    ...
    public class FolderBrowserExtended : CommonDialog
    {
        ...
        // ctor
        public FolderBrowserExtended()
        {
            this.Reset();
        }

        // Factory Methods
        public static FolderBrowserExtended PrinterBrowser()
        {
            FolderBrowserExtended x = new FolderBrowserExtended();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
            x.BecomePrinterBrowser();
            return x;
        }

        public static FolderBrowserExtended ComputerBrowser()
        {
            FolderBrowserExtended x = new FolderBrowserExtended();
            // avoid MBRO comppiler warning when passing _rootFolderLocation as a ref:
